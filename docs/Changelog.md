...
## v0.2.5
**Release time:** 2025-9-5

✨ **Added**
- Added version information in settings
- Added image upload feature for tasks
- Added registration switch control middleware

🐛 **Fixed**
- Fixed image upload naming conflicts
- Fixed registration switch state synchronization issue
